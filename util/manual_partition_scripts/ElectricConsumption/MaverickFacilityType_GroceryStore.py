...
if __name__ == "__main__":
    ...
    slice_training_function_2 = (x_train["facility_type_Grocery_store_or_food_market"] == 1)
    slice_test_function_2 = (x_test["facility_type_Grocery_store_or_food_market"] == 1)
